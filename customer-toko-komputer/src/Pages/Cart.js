...
export default class Cart extends React.Component {
    constructor() {
        super()
        // siapkan state yang kita butuhkan untuk halaman cart
        this.state = {
            token: "",
            customerID: "",
            customerName: "",
    ...
    // function header config -> untuk memberikan header berupa 'bearer token' sebagai
    // request API sebelum mengakses data
    headerConfig = () => {
        let header = {
    ...
    // function initCart -> untuk mengambil data dari local storage, serta menghitung total harga
    initCart = () => {
    ...
    // function edit data -> untuk mengupdate jumlah product/qty cart pada local storage
    ...
    // saveCustomer -> untuk menyimpan data pada db dengan mengakses API


    // dropItem -> untuk menghapus keranjang
    ...
    // function checkOut -> untuk menambahkan data transaksi
    checkOut = () => {
        let tempCart = []
        if (localStorage.getItem("cart") !== null) {
            tempCart = JSON.parse(localStorage.getItem("cart"))
    ...
    // akses fungsi initCart pada componentDidMount
    componentDidMount() {
        this.initCart()
    }
